...
### Global installation
You can also use the modification system wide by cloning / extracting this repository where ever you like and then place the mod_autoindex.conf in /etc/apache2/other.
